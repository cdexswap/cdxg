export const SocialLinks = () => {
  return (
    <>
      {/* Desktop Version */}
      <div className="fixed top-4 left-10 z-30 hidden xl:flex flex-row gap-4">
        <a 
      ...
      {/* Mobile Version */}
      <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-30 flex xl:hidden flex-row gap-4">
        <a 
          href="https://x.com/khaituntiger" 
          target="_blank" 
          rel="noopener noreferrer"
